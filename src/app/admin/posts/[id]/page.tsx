        ...
        <main className="mx-auto min-h-[calc(100vh-57px)] w-full max-w-4xl px-5 py-8">
            ...
            <form action={`/api/admin/posts/${post.id}`} method="post" className="grid gap-4 rounded border border-neutral-300 bg-white p-5">
                ...
                <div className="flex flex-wrap gap-3">
                    ...
                    <ConfirmSubmitButton className="rounded border border-red-300 bg-white px-4 py-2 hover:border-red-600 text-red-600" name="action" value="delete" title="删除文章" description="此操作不可恢复">删除</ConfirmSubmitButton>
                </div>
            </form>
        </main>
    )
